//
//  StudentUspevTableViewController.swift
//  Bazis MADI
//
    ...
    private func setupNavBar() {
        if let student = studentInfo {
            ...
            if SystemDevice().isNormalDevice {
                title = "Успеваемость: " + String(buff[0])
            } else {
                title = String(buff[0])
            }
        }
...
extension StudentUspevTableViewController {
...
extension StudentUspevTableViewController: UISearchControllerDelegate {
