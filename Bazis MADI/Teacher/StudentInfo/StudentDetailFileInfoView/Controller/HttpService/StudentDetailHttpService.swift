...
class StudentDetailHttpService {
    ...
    class func deleteReviewFile(nameFile: String, studUIC:String, reviewName: String, complition: @escaping(Error?, ResultModel?) -> Void) {
        
        let urlStr = "https://bazis.madi.ru/stud/api/file/desc"
        let body = "&p=\(nameFile)&uic=\(studUIC)&refdel=\(reviewName)"
